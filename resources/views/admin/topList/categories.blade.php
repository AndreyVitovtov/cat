...
@section("h3")
    <h3>@lang('pages.top_of_the_list_are_channels_by_category') <b>({{ $categoryName->name }})</b></h3>
@endsection
    ...
    <div class="top-list">
        <div>
            <div class="overflow-X-auto">
                <form action="{{ route('top-list-category', ['category' => $category]) }}" id="switch-messenger">
                </form>
                <div class="switch">
